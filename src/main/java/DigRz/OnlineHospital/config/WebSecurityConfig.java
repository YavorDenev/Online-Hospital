...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .mvcMatchers("/patient/show", "/appointment/show-all","/appointment/doctor_inputs","/appointment/submit_inputs","/appointment/doctor_appointments").hasAnyAuthority("ROLE_DOCTOR", "ROLE_ADMIN")
